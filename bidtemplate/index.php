          ...
          <div class="item">
            <div class="img-fill">
                ...
                <div class="text-content">
                  <h3>Welcome To BIDEAL</h3>
                  <h5>Complete Bidding Platform</h5>
                  <a href="register.php" class="main-stroked-button">Register for FREE</a>
                  <a href="login.php" class="main-filled-button">LOGIN</a>
                </div>
            </div>
          </div>
          <!-- // Item -->
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="right-text-content">
                        <p><a rel="nofollow noopener">We offer sellers the ability to grow a business with little barrier to entry regardless of size, background or geographic location. We never compete with our sellers. We win when our sellers succeed.
                      <br><br>Customers on bideal enjoy a highly personalized experience with an unparalleled selection at great value.<a rel="nofollow noopener" target="_parent">talk to us</a> if you have anything.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4 col-md-4 col-xs-12">
                    <div class="left-text-content">
                        ...
                        <ul class="contact-info">
                            ...
                            <li><img src="assets/images/contact-info-02.png" alt="">bideal@ac.in</li>
                            <li><img src="assets/images/contact-info-03.png" alt="">www.bideal.com</li>
                        </ul>
                    </div>
                </div>
