...
<head>
    ...
    <title>BIDEAL || Products on Bid</title>
    <!-- Bootstrap CSS -->
...
$q=mysqli_query($con,"SELECT * from catagories c,products p,user u where c.id=p.catagory_id and u.id=p.uid and c.name='$n' and p.status=1;");
