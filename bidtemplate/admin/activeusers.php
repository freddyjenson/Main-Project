...
<head>
    ...
    <title>BIDEAL || Active Users</title>
    <!-- Bootstrap CSS -->
...
$q=mysqli_query($con,"SELECT DISTINCT * FROM `user` WHERE status=1 and utype='0';");
...
<tr>
                  ...
                  <td><button name="dis"><a href="activedeactive.php?id=<?php echo $row['id']; ?>">disable</a></button>
                  </td> 
